...
const articleMaker = article =>{
  ...
  // Creating Element Variables that hold DOM values
const divHolder = document.createElement('div');
const h2Holder = document.createElement('h2');
const pHolder1 = document.createElement('p');
const pHolder2 = document.createElement('p');
